...
test("job só conclui quando contém todo o contrato estratégico da skill", () => {
  ...
  assert.ok(gaps.includes("Mapa cronológico"));
  assert.ok(gaps.includes("Justificativa da fronteira"));
